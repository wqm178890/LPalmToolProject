...
- (NSDictionary *)getAllSystemInformation {
    ...
    NSString *ScreenWidthStr = [NSString stringWithFormat:@"%d", [self screenWidth]];
    NSString *ScreenHeightStr = [NSString stringWithFormat:@"%d", [self screenHeight]];
    ...
    if (ScreenWidthStr == nil || ScreenWidthStr.length <= 0) {
        // Invalid value
        ScreenWidthStr = @"Unknown";
    }
    if (ScreenHeightStr == nil || ScreenHeightStr.length <= 0) {
        // Invalid value
        ScreenHeightStr = @"Unknown";
    }
